...
# Cargar el CSV
df = pd.read_csv('molinetes_2017_con_feriados.csv')
...
df['ESTACION'] = df['ESTACION'].replace('SAENZ PE�A', 'SAENZ PENIA')

df['LINEA'] = df['LINEA'].str.replace('LINEA_', '')
...
df.to_csv('molinetes_2017_con_zonas.csv', index=False)
