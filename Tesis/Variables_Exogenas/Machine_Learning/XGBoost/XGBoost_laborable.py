...
csv_file_name = "Con_Laborable.csv"
...
X_train = train[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','LABORABLE']]
y_train = train['TOTAL']

X_test = test[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','LABORABLE']]
y_test = test['TOTAL']
########################################
param_grid = {
