...
csv_file_name = "Con_Laborable_LAG2.csv"
...
X_train = train[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','LABORABLE_LAG2']]
y_train = train['TOTAL']

X_test = test[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','LABORABLE_LAG2']]
y_test = test['TOTAL']
# ########################################
