...
csv_file_name = "Con_Precipitacion_LAG1.csv"
...
X_train = train[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','PRECIPITACION_LAG1']]
y_train = train['TOTAL']

X_test = test[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','PRECIPITACION_LAG1']]
y_test = test['TOTAL']
########################################
param_grid = {
