...
csv_file_name = "Con_Precipitacion.csv"
...
X_train = train[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','PRECIPITACION']]
y_train = train['TOTAL']

X_test = test[['Year', 'Month', 'Day', 'DiaSemana', 'DiaAnio', 'PROMEDIO_MOVIL','PRECIPITACION']]
y_test = test['TOTAL']
########################################
param_grid = {
