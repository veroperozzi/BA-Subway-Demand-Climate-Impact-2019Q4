...
filname = 'Con_Precipitacion_LAG2.csv'
...
df.columns = ['ds', 'y','PRECIPITACION_LAG2']
df.head()
...
for param in params:
    m = Prophet(**param)
    m.add_regressor('PRECIPITACION_LAG2')
...
future['PRECIPITACION_LAG2'] = df['PRECIPITACION_LAG2'].values[:len(future)]
