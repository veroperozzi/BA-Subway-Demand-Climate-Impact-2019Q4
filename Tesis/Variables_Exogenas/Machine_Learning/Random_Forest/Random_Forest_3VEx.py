...
X_train = train[
    ['Year', 'Month', 'Day', 'PRECIPITACION', 'FERIADO', 'LABORABLE', 'L1', 'L2', 'L3', 'L4', 'L5', 'L6', 'L7']]
y_train = train['TOTAL']
...
my_rf = RandomForestRegressor(n_estimators=n_estimators, max_depth=max_depth, min_samples_split=min_samples_split,
                              random_state=42)
