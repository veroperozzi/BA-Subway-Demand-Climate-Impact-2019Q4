...
csv_file_name = "Con_Precipitacion_LAG2.csv"
...
X_train = train[['Year', 'Month', 'Day', 'PRECIPITACION_LAG2', 'L1', 'L2', 'L3', 'L4', 'L5', 'L6', 'L7']]
y_train = train['TOTAL']

X_test = test[['Year', 'Month', 'Day', 'PRECIPITACION_LAG2', 'L1', 'L2', 'L3', 'L4', 'L5', 'L6', 'L7']]
y_test = test['TOTAL']
