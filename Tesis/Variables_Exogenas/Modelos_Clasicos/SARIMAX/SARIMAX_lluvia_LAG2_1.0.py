...
SARIMA_model = SARIMAX(target_train, exog=exog_train, order=(1, 0, 3), seasonal_order=(1, 0, 3, 7), simple_differencing=False)
...
ax.plot(test.index, test['SARIMA_pred'], color='green', linestyle='--', label='SARIMA(1,0,3)(1,0,3,7)')
