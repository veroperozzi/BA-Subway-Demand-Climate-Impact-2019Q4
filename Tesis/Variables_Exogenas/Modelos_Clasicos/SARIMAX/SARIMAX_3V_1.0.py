...
target = df['TOTAL']
exog = df[['PRECIPITACION', 'FERIADO', 'LABORABLE']]
...
SARIMA_model = SARIMAX(target_train, exog=exog_train, order=(5, 0, 3), seasonal_order=(2, 0, 2, 7), simple_differencing=False)
...
ax.plot(test.index, test['SARIMA_pred'], color='green', linestyle='--', label='SARIMA(5,0,3)(2,0,2,7)')
