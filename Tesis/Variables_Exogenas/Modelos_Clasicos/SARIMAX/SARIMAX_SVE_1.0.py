...
target_train = df['TOTAL'][0:1366]
#exog_train = exog[0:1366]

target_test = df['TOTAL'][1366:1457]
...
SARIMA_model = SARIMAX(target_train,order=(3, 0, 3), seasonal_order=(2, 0, 3, 7), simple_differencing=False)
...
#Prediccion
# Predicción
SARIMA_pred = SARIMA_model_fit.get_prediction(start=1366, end=1456).predicted_mean
...
ax.plot(test.index, test['SARIMA_pred'], color='green', linestyle='--', label='SARIMA(1,0,1)(2,0,1,7)')
