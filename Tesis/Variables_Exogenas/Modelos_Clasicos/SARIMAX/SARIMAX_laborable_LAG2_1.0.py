...
SARIMA_model = SARIMAX(target_train, exog=exog_train, order=(6, 0, 3), seasonal_order=(2, 0, 4, 7), simple_differencing=False)
...
ax.plot(test.index, test['SARIMA_pred'], color='green', linestyle='--', label='SARIMA(6,0,3)(2,0,4,7)')
