...
SARIMA_model = SARIMAX(target_train, exog=exog_train, order=(3, 0, 2), seasonal_order=(1, 0, 2, 7), simple_differencing=False)
...
ax.plot(test.index, test['SARIMA_pred'], color='green', linestyle='--', label='SARIMA(3,0,2)(1,0,2,7)')
...
mae_n_error = mae_n(test.actual, test.SARIMA_pred)
